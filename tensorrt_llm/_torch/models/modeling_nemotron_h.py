...
class NemotronHMOE(nn.Module):
    ...
    def __init__(
        ...
        # NVFP4-quantized and latent projection is not used (unsupported by b12x).
        ...
        if (get_sm_version() in (120, 121) and nvfp4_moe
                and not self.use_latent_moe and ep_size
